...
[![GoDoc](https://godoc.org/github.com/yurulab/gocryptotrader?status.svg)](https://godoc.org/github.com/yurulab/gocryptotrader/currency/forexprovider/currencyconverterapi)
...
+ [Enable via configuration](https://github.com/yurulab/gocryptotrader/tree/master/config#enable-currency-via-config-example)

+ Individual package example below:
```go
import (
	"github.com/yurulab/gocryptotrader/currency/forexprovider/base"
	"github.com/yurulab/gocryptotrader/currency/forexprovider/currencyconverter"
)
